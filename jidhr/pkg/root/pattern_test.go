...
var battery = []struct{ word, want, why string }{
	...
	{"مدير", "دور", "a hollow root whose و the form writes as ي, beside the real root د ي ر it is spelled like"},
	{"منير", "نور", "a hollow root whose و the form writes as ي, beside the real root ن ي ر it is spelled like"},
